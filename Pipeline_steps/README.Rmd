...
# Set the variables
SampleID=TBNGS-214
FASTQDIR=/shared/projects/virus_coinfect_m/fastq
SPADESDIR=/shared/home/marglefebvre/softwares/SPAdes-4.0.0-Linux/bin
DBDIAMOND=/shared/projects/virus_coinfect_m/diamond_db/ncbi-nr.taxonomy.dmnd
TAXONKITDIR=/shared/projects/virus_coinfect_m/diamond_db/Taxonkit
PROTACCESION=/shared/projects/virus_coinfect_m/diamond_db/prot.accession2taxid.txt
SILVAREF=/shared/projects/virus_coinfect_m/SILVA/SILVA.DB.fasta

TEMPDIR=/shared/projects/virus_coinfect_m/temp_$SampleID
RESULTDIR=/shared/projects/virus_coinfect_m/test_taxo_$SampleID
...
```
*Digital normalization is applied solely for the assembly step, while the complete set of sequences is retained for quantification.*
...
```{bash}
# Check the QC with Multiqc
cp $TEMPDIR/Bam/${SampleID}_contigs_reads.tsv $TEMPDIR/fastQC/reads_counts.idx.stats
cd $TEMPDIR/fastQC/
multiqc .
