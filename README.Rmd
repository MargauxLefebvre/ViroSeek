...
You can run the pipeline directly with the bash script `ViroSeek.sh` (located in this directory). Feel free to modify or adapt it to fit your needs.
...
* ViroSeek.nf: the main Nextflow pipeline script included in this repository.
* nextflow.config: Configuration file that defines compute profiles (e.g., SLURM, SGE) and pipeline parameters, also included in this repository.
